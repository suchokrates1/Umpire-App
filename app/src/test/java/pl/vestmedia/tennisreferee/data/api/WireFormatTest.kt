...
class WireFormatTest {
    ...
    fun createAndUpdateMatchBody() {
        assertEquals(
            ...
            gson.toJson(MatchApiPayloadFactory.toMatch(state())),
        )
    }
    ...
    fun finishMatchBody() {
        ...
        assertEquals(
            ...
            gson.toJson(MatchApiPayloadFactory.toFinishRequest(finished).toDto()),
        )
    }
    ...
    fun statisticsBody() {
        ...
        assertEquals(
            ...
            gson.toJson(MatchApiPayloadFactory.toStatisticsRequest(finished)),
        )
    }
    ...
    fun directorSnapshotBody() {
        assertEquals(
            ...
            gson.toJson(MatchApiPayloadFactory.toDirectorSnapshot(state())),
        )
    }
}
